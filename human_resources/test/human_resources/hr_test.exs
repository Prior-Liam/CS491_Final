defmodule HumanResources.HrTest do
  use HumanResources.DataCase

  alias HumanResources.Hr

  describe "employees" do
    alias HumanResources.Hr.Employee

    import HumanResources.HrFixtures
    ...
    test "create_employee/1 with valid data creates a employee" do
      valid_attrs = %{department: "some department", employee_id: 42, first_name: "some first_name", hire_date: ~D[2023-05-04], last_name: "some last_name"}
    ...
    test "update_employee/2 with valid data updates the employee" do
      employee = employee_fixture()
      update_attrs = %{department: "some updated department", employee_id: 43, first_name: "some updated first_name", hire_date: ~D[2023-05-05], last_name: "some updated last_name"}
      ...
      assert employee.hire_date == ~D[2023-05-05]
