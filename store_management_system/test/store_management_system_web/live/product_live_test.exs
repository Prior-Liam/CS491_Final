defmodule StoreManagementSystemWeb.ProductLiveTest do
  use StoreManagementSystemWeb.ConnCase

  import Phoenix.LiveViewTest
  import StoreManagementSystem.SmsFixtures

  @create_attrs %{inventory_count: 42, name: "some name", retail_price: 42, vendor_name: "some vendor_name", whole_sale_price: 42}
