defmodule StoreManagementSystemWeb.ProductLive.FormComponent do
  ...
  def update(%{product: product} = assigns, socket) do
    changeset = Sms.change_product(product)
  ...
  def handle_event("validate", %{"product" => product_params}, socket) do
    changeset =
      ...
      |> Sms.change_product(product_params)
  ...
  defp save_product(socket, :edit, product_params) do
    case Sms.update_product(socket.assigns.product, product_params) do
      {:ok, product} ->
  ...
  defp save_product(socket, :new, product_params) do
    case Sms.create_product(product_params) do
      {:ok, product} ->
        notify_parent({:saved, product})
