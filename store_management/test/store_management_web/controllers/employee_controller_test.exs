defmodule StoreManagementWeb.EmployeeControllerTest do
  use StoreManagementWeb.ConnCase

  import StoreManagement.HrFixtures

  @create_attrs %{department: "some department", employee_id: 42, first_name: "some first_name", hire_date: ~D[2023-04-20], last_name: "some last_name"}
